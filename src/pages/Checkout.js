...
const handleSubmit = (e) => {
    ...
    navigate('/thank-you'); // Redirect to a thank you page or home page

    // Clear cart logic can be added here
    // For example, if using a context or state management, you can call a function to
    // clear the cart items.
    // cartContext.clearCart(); // Assuming clearCart is a function in cartContext
